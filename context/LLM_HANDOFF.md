...
- Current version: `APP_VERSION = "4.7.6.6"` — active WISH-061 development line **4.7.6**, with 4.7.6.6 "Full Radius" implementing WISH-078: inset-frame cue endings, End-independent mainland/inset ring projection, curve-sampled top-layer labels, signed comparison time-zone deltas, full-depth shading, and live hover-band hints. WISH-079 remains the mobile center-crosshair follow-up. Active plan: `context/WISH-061-RANGEFINDER-EDGECASES-PLAN.md`. Latest cut release remains **4.7.5 "Gridlines"**.
