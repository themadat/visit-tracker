...
- Current version: `APP_VERSION = "4.7.6.8"` — active WISH-061 development line **4.7.6**. 4.7.6.6 "Full Radius" implemented WISH-078; 4.7.6.7 compacted Times & Arrival into the comparison row, and 4.7.6.8 "Time Window" replaces that text control with a curved-route icon opening a scrollable inset planner over the Rangefinder panel. WISH-079 remains the mobile center-crosshair follow-up. Active plan: `context/WISH-061-RANGEFINDER-EDGECASES-PLAN.md`. Latest cut release remains **4.7.5 "Gridlines"**.
...
- Open follow-ups: WISH-077 (unified anchored control pop-ups, P0); WISH-079 (mobile center-crosshair Rangefinder, P1); WISH-076 (native-language World labels, P1); WISH-073 (Basecamp photo support, P2).
