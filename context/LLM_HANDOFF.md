...
- Current version: `APP_VERSION = "4.7.1.2"` — active development line **4.7.1 "Atlas Ink"** for WISH-057 "Smarter World Map Labels"; plan in `context/WISH-057-WORLD-MAP-LABELS-PLAN.md` (declutter + shrink-to-fit, multiline labels, leader-line microstate/backup labels, and English short names; world map only).
