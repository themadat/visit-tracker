...
- Current version: `APP_VERSION = "4.7.6.7"` — active WISH-061 development line **4.7.6**. 4.7.6.6 "Full Radius" implemented WISH-078; 4.7.6.7 "Same Time" compacts Times & Arrival into the right side of the distance/time comparison row while keeping expanded planning details below. WISH-079 remains the mobile center-crosshair follow-up. Active plan: `context/WISH-061-RANGEFINDER-EDGECASES-PLAN.md`. Latest cut release remains **4.7.5 "Gridlines"**.
