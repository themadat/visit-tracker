...
- Current version: `APP_VERSION = "4.7.1.6"` — active development line **4.7.1 "Atlas Ink"** for WISH-057 "Smarter World Map Labels"; plan in `context/WISH-057-WORLD-MAP-LABELS-PLAN.md` (atlas-density shape labels, multiline labels, dot-only leader lines with edge clamping, cluster-specific offsets, Tune-mode manual overrides/export, and English short names; world map only).
