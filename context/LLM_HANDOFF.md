...
- Current version: `APP_VERSION = "4.8.0.1"` — active **4.8.0 "Square Deal"** dev line for WISH-077. Anchored control pop-ups now share 36px controls / 32px inset choices / 40px bordered frames and viewport clamping; desktop side-column Rangefinder stacks below Legend until the side reaches 40% width, then splits beside it; `|` switches maps and `~` opens labels; Wayfinder is Notes-only; Text Only owns its inset Copy button. Latest cut release remains **4.7.6 "Dead Reckoning"**.
