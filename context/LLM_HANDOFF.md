...
- Plan docs live in `context/` only while their line is in flight, then are deleted on ship. Active plan: `WISH-074-llm-slim-PLAN.md` (4.4.1 line, implemented; `prep`/`ship` remain).
