...
- Current version: `APP_VERSION = "4.8.0.3"` — active **4.8.0 "Square Deal"** dev line for WISH-077. Anchored controls share the 36px / 32px / 40px size system; desktop side-column Rangefinder stacks below Legend until the side reaches 40% width, then splits beside it; Rangefinder endpoint labels wrap inside their fixed-height slots; map actions stay aligned as modes change; `|`, `:`, `9`–`6`, `'`, and `←` cover map switching, layout, toggles, label targets, and label modes; Wayfinder remains Notes-only; Text Only floats Copy above its text surface. Latest cut release remains **4.7.6 "Dead Reckoning"**.
