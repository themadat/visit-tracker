...
- Current version: `APP_VERSION = "4.7.6.2"` — active WISH-061 development line **4.7.6 "Around the Clock"**. Scope: compass-correct cross-inset Rangefinder cues with geodesic ring arcs in the End region, World antimeridian ring/cue wrapping, and offline IANA time-zone clocks plus departure/arrival planning. Active plan: `context/WISH-061-RANGEFINDER-EDGECASES-PLAN.md`. Latest cut release remains **4.7.5 "Gridlines"**.
