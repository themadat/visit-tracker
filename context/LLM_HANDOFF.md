...
- Current version: `APP_VERSION = "4.6.1.1"` — active patch line **4.6.1 "A Small World"** improves map-layer switching and repairs the `Shift+Control+Option+~` shortcut. Latest cut release is **4.6.0 "The Whole Story"**. No active plan; this is a small direct implementation.
