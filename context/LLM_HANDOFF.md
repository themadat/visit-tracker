...
- Current version: `APP_VERSION = "4.7.6.10"` — active WISH-061 development line **4.7.6**. 4.7.6.10 "Clear Air" moves ring-band hover hints above-right of the pointer and simplifies them to spaced distance/time ranges. WISH-080 is a P0 exact 5.1.0 target for Apple/Google Maps preference plus Google Flights in Plane mode; WISH-079 remains the mobile center-crosshair follow-up. Active plan: `context/WISH-061-RANGEFINDER-EDGECASES-PLAN.md`. Latest cut release remains **4.7.5 "Gridlines"**.
