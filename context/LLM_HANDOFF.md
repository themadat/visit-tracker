...
- Current version: `APP_VERSION = "4.7.2.3"` — active dev line **4.7.2 "Trail Marks"**: WISH-077 (Roadmap plan-ready ticket pill + planDoc on all wishes with a plan doc), WISH-078 (headed release-notes Full Update List), WISH-068 (raptor easter egg — tap Niihau, the westernmost Hawaii island, on the US map). Roadmap cards show Priority/Effort/Cost/Target/Category on one meta line; Oldest/Newest sort by ticket number. Latest cut release: **4.7.1 "Atlas Ink"** (smarter World map labels).
