...
- Current version: `APP_VERSION = "4.7.0"` — latest cut release **4.7.0 "Priority"** on branch `4-7-0-priority`; no active plan doc.
...
- Plan docs live in `context/` only while their line is in flight, then are deleted on ship. No active plan doc.
