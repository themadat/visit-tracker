...
- Waypoint Packs: Wayfinder-only Packs button `#notesAddWaypointsBtn`
  ...
  Website, Photo, Edit/Link, and Unlink use larger square icon buttons; Priority
  uses compact large-number outline controls. The inset Packs panel follows
  Notes resizing. Linking appends waypoint details and
