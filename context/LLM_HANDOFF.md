...
- Current version: `APP_VERSION = "4.7.6.9"` — active WISH-061 development line **4.7.6**. 4.7.6.8 "Time Window" added the inset planner; 4.7.6.9 "Clockwork" makes its Close, Apply, Auto, Now, and Choose controls icon-led and vertically compacts the planner. WISH-080 adds a P0 Google/Apple Maps Rangefinder handoff follow-up; WISH-079 remains the mobile center-crosshair follow-up. Active plan: `context/WISH-061-RANGEFINDER-EDGECASES-PLAN.md`. Latest cut release remains **4.7.5 "Gridlines"**.
...
- Open follow-ups: WISH-077 (unified anchored control pop-ups, P0); WISH-080 (Google/Apple Maps Rangefinder handoff, P0); WISH-079 (mobile center-crosshair Rangefinder, P1); WISH-076 (native-language World labels, P1); WISH-073 (Basecamp photo support, P2).
