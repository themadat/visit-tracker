...
|---|---:|---|---|
| 4.5.0 | 2026-06-12 | Mobile Cleanup | A broad small-screen pass: Basecamp becomes a pad list plus full-screen editor, Notes fill more of the screen, and the map, note editor, pop-up menus, and linked-note photos all behave on phones. |
